def calcular_potencia(base, exponente):
    """
    Calcula la potencia de un número usando un bucle.
    Retorna el resultado final y el número de multiplicaciones.
    """
    if exponente == 0:
        return 1, 0
    if exponente < 0:
    ...
    # Bucle para realizar las multiplicaciones
...
# Probando la calculadora de potencia
